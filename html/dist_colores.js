...
function parseFile(file, callback) {
    ...
    var readEventHandler = function(evt) {
		...
		//Ajustamos la velocidad marcada por la interficie (si no ha sido modificada simplemente seguira igual)
		velocidad = velocidadInterficie
...
function aumenta_rapidez(){
	...
	if(velocidadInterficie>0){
		velocidadInterficie-=100
	}
}
...
function avanza_hora(){
	...
	var minutos = 0
	while (indiceActual < sizes.length && minutos < 60) {
